  ...
  Blog_CI-CD:
    ...
    steps:
      ...
      - name: upload GitHub repository
        env: 
          # Github 仓库
          GITHUB_REPO: github.com/zhoujinjianmsn/zhoujinjianmsn.github.io
         # 将编译后的博客文件推送到指定仓库
        run: |
          cd ./public && git init && git add .
          git config user.name "zhoujinjianmsn"       #username改为你github的用户名
          git config user.email "zhoujinjianmsn@gmail.com"     #username改为你github的注册邮箱
          git add .
