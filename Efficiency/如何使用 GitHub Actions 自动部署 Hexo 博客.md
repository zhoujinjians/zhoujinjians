...
-   **私有仓库**用来存储 Hexo 项目源代码。（保证你的重要信息不泄露）
    ...
    ![](https://raw.githubusercontent.com/zhoujinjiancc/zhoujinjian.com.images/master/others/SCR-20220410-vrk.png)
    
-   **公共仓库**用来存储编译之后的静态页面。
    
    ![](https://raw.githubusercontent.com/zhoujinjiancc/zhoujinjian.com.images/master/others/SCR-20220410-vsg.png)
...
![](https://raw.githubusercontent.com/zhoujinjiancc/zhoujinjian.com.images/master/others/SCR-20220410-vvq.png)
...
![](https://raw.githubusercontent.com/zhoujinjiancc/zhoujinjian.com.images/master/others/SCR-20220410-vo6.png)
...
![](https://raw.githubusercontent.com/zhoujinjiancc/zhoujinjian.com.images/master/others/SCR-20220410-vlq.png)
  ...
  Blog_CI-CD:
    ...
    steps:
      ...
      - name: upload GitHub repository
        env: 
          # Github 仓库
          GITHUB_REPO: github.com/zhoujinjiancc/zhoujinjiancc.github.io
         # 将编译后的博客文件推送到指定仓库
        run: |
          cd ./public && git init && git add .
          git config user.name "zhoujinjiancc"       #username改为你github的用户名
          git config user.email "zhoujinjiancc@gmail.com"     #username改为你github的注册邮箱
          git add .
...
4.  在私有仓库的 Actions 可以查看到你配置的 action ![](https://raw.githubusercontent.com/zhoujinjiancc/zhoujinjian.com.images/master/others/Hexo_Butterfly_Blog_Source.png)
    
5.  通过 GitHub Actions 自动部署成功的效果图： ![image](https://raw.githubusercontent.com/zhoujinjiancc/zhoujinjian.com.images/master/others/zhoujinjiancc.github.io.png)
