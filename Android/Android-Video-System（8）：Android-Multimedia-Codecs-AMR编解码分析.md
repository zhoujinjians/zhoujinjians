...
cover: https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/hexo.themes/bing-wallpaper-2018.04.30.jpg
categories:
  - Multimedia
tags:
  - Android
...
Log：
[AMR-DEcorder-Google-Log.md](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/AMR-DEcorder-Google-Log.md)
[AMR-Encorder-Google-Log.md](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/AMR-Encorder-Google-Log.md)
--------------------------------------------------------------------------------
...
![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-01-AMR-NB-Codecs-16.png)

2. AMR-WB:

![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-02-AMR-WB-Codecs-16.png.png)
...
1. AMR IF1:
 IF1 的帧格式如下图所示：
  ![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-03-AMR IF1.jpg)
...
2. AMR IF2:
 IF2的帧格式如下图所示：
  ![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-04-AMR IF2.jpg)
...
##### 四、帧大小
1. AMR-NB
![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-05-AMR-NB-Frame.png)


Number of bits in Classes A, B, and C for each AMR codec mode
![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-06-AMR-NB-Frame-Number.png)

2. AMR-WB:
Composition of AMR-WB IF2 Frames for all Frame Types
![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-07-AMR-WB-Frame.png.png)

![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-08-AMR-WB-Frame-number.png.png)
...
![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-09-AMR-magic number.jpg)
...
![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-10-AMR-WB-magic number.jpg)


32bit的channel description域的定义如下：

![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-11-AMR-channel description-.jpg)
...
![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-12-AMRNB-Encorder-flow.png)
...
以上是解码初始化信息，先看看流程图
![Alt text | center](https://raw.githubusercontent.com/zhoujinjianmax/PicGo/master/android.codecs/VS8-13-AMRNB-Decorder-flow.png)
