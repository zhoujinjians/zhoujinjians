...
cover: https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/personal.website/post.cover.pictures.00009.jpg
categories:
  - Audio
tags:
  - Android
...
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/31-Audio-system-Android-Linux-arc.png)
...
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/32-Audio-system-mixerthread.jpg)
...
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/33-Audio-system-Audio-playback-.png)
...
总体流程图：
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/34-Audio-system-CreateAudioPolicyManager.png)
...
[audio_policy_configuration.xml](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/audio_policy_configuration.xml)
audio_policy.conf同时定义了多个audio 接口，每一个audio 接口包含若干output和input，而每个output和input又同时支持多种输入输出模式，每种输入输出模式又支持若干种设备。
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/35-Audio-system-audio_policy.conf.png)
...
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/36-Audio-system-audiohwdevice.png)

##### 2.3.4、打开对应的outputStream和inputStream
前面一小节已经分析过outputStream，这里不再分析了
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/37-Audio-system-AudioStreamOut.png)

打开音频输出后，在AudioFlinger与AudioPolicyService中的表现形式如下：
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/38-Audio-system-audiohwdevice-openoutput.png)

打开音频输入:
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/39-Audio-system-AudioStreamIn.png)
打开音频输入后，在AudioFlinger与AudioPolicyService中的表现形式如下：
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/310-Audio-system-audiohwdevice-openinput.png)
...
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/311-Audio-system-audio_stream_in-out.png)
...
时序图：
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/312-Audio-system-create_audiotrack-flow.png)

首先看一下 AudioTrack & AudioFlinger 的类图，理一下 AudioFlinger 的主要类及其关系、AudioTrack 与 AudioFlinger 之间的联系，后面将以该图为脉络展开分析。
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/313-Audio-system-create_audiotrack.jpg)
...
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/314-Audio-system-PlaybackThread-Track-TrackHandle.png)
...
FIFO 管理相关的类图：
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/315-Audio-system-FIFO.jpg)
...
时序图：
![Alt text](https://raw.githubusercontent.com/zhoujinjianx/PicGo/master/audio.system/316-Audio-system-mediaplayer-playback.png)
