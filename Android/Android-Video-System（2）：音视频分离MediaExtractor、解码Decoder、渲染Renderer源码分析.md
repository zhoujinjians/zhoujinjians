...
cover: https://raw.githubusercontent.com/zzhoujinjian/PicGo/master/hexo.themes/bing-wallpaper-2018.04.17.jpg
categories:
  - Multimedia
tags:
  - Android
...
![Alt text](https://raw.githubusercontent.com/zzhoujinjian/PicGo/master/video.system/02-01-source-demux-decoder-output-MediaExtractor.jpg)

#### （二）、多媒体文件 - 音视频解码（Decoder）
音频解码、视频解码在何处，答案就在mMediaPlayer.start()流程当中，先看看start()总体时序图，然后一步步分析

![Alt text](https://raw.githubusercontent.com/zzhoujinjian/PicGo/master/video.system/02-02-NuPlayer-Start-instantiateDecoder.png)
...
![Alt text](https://raw.githubusercontent.com/zzhoujinjian/PicGo/master/video.system/02-03-acodec-emptyBuffer.png)
...
![Alt text](https://raw.githubusercontent.com/zzhoujinjian/PicGo/master/video.system/02-04-acodec-fillBuffer.png)
...
![Alt text](https://raw.githubusercontent.com/zzhoujinjian/PicGo/master/video.system/02-05-source-demux-decoder-output-render.jpg)
...
static_cast<Surface*>(mNativeWindow.get())
        ->getIGraphicBufferProducer()->allowAllocation(true);
```
![Alt text](https://raw.githubusercontent.com/zzhoujinjian/PicGo/master/video.system/02-06-Surface-ANativeWindow.png)
...
```
![Alt text](https://raw.githubusercontent.com/zzhoujinjian/PicGo/master/video.system/02-07-OpenMax-Based video decode-surfaceflinger.png)
