...
cover: https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/post.cover.pictures/bing-wallpaper-2018.04.42.jpg
categories:
 - Linux
tags:
 - Linux
...
[【me.zhoujinjian.com博客原图链接】](https://github.com/zhoujinjiankim) 
...
![](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/005_i2c_hardware_connect.png)
...
![](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/006_teacher_and_student.png)
...
![](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/007_i2c_write.png)
...
![](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/008_i2c_read.png)
...
![](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/009_i2c_signal.png)
...
* 双方设备中，某个设备发送数据时，另一方怎样才能不影响SDA上的数据？
  ...
  ![](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/010_i2c_signal_internal.png)

真值表如下：
![](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/011_true_value_table.png)
...
![image-20210224093827621](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/017_i2c_and_smbus.png)
...
* REPEATED START Condition(重复发出S信号)
  ...
  * 如下图所示
    ![image-20210224100056055](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/018_repeated_start.png)
...
![image-20210224105224903](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/019_smbus_quick_command.png)
...
![image-20210224113511225](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/020_smbus_receive_byte.png)
...
![image-20210224110638143](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/021_smbus_send_byte.png)
...
![image-20210224110812872](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/022_smbus_read_byte.png)
...
![image-20210224111404096](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/023_smbus_read_word.png)
...
![image-20210224111542576](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/024_smbus_write_byte.png)
...
![image-20210224111840257](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/025_smbus_write_word.png)
...
![image-20210224112524185](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/026_smbus_block_read.png)
...
![image-20210224112629201](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/027_smbus_block_write.png)
...
![image-20210225094024082](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/033_i2c_block_read.png)
...
![image-20210225094359443](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/034_i2c_block_write.png)
...
![image-20210224112940865](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/028_smbus_block_write_block_read_process_call.png)先写一块数据，再读一块数据。
...
![image-20210224113416249](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/029_smbus_pec_example.png)
...
![image-20210208125100022](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/001_i2c_hardware_block.png)
...
![image-20210220150757825](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/007_i2c_write-16299579619801.png)

* 读操作

![image-20210220150954993](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/008_i2c_read-16299579619802.png)



## 3.3. Linux软件框架

![image-20210219173436295](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/003_linux_i2c_software_block.png)
...
* 怎么表示I2C Controller
  ...
  * i2c_adapter
  ...
  ![image-20210223103217183](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/012_i2c_adapter.png)

  * i2c_algorithm
    ![image-20210223100333813](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/013_i2c_algorithm.png)
...
* 怎么表示I2C Device
  ...
  * 使用i2c_client来表示一个I2C Device
    ![image-20210223100602285](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/014_i2c_client.png)
...
* 怎么表示要传输的数据
  ...
  * i2c_msg
    ![image-20210223100924756](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/015_i2c_msg.png)
...
* 内核函数i2c_transfer
  ...
  * i2c_msg里含有addr，所以这个函数里不需要i2c_client
  ...
  ![image-20210223102320133](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/016_i2c_transfer.png)
...
![image-20210224172517485](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/030_i2ctools_and_i2c_dev.png)
...
![032_i2cget_i2cset_flow](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/032_i2cget_i2cset_flow.png)
...
![image-20210226154141671](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/045_char_driver.png)
...
## 5.2. i2c-dev.c注册过程分析
 ...
 ### 5.2.1 register_chrdev的内部实现
  ...
  ![image-20210226163844390](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/046_register_chrdev_internal.png)



### 5.2.2 i2c-dev驱动的注册过程

![image-20210226164128588](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/047_i2c-dev_register.png)
...
主要的系统调用：open, ioctl：
![image-20210226165250492](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/048_i2c-dev_interface.png)
...
![image-20210226170350844](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/049_i2cdev_open.png)



### 5.3.2 i2cdev_ioctl: I2C_SLAVE/I2C_SLAVE_FORCE

![image-20210226172800990](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/050_ioctl_I2C_SLAVE_FORCE.png)



### 5.3.3 i2cdev_ioctl: I2C_RDWR

![image-20210226173625871](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/051_ioctl_I2C_RDWR.png)

### 5.3.4 i2cdev_ioctl: I2C_SMBUS

![image-20210226173952800](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/052_ioctl_I2C_SMBUS.png)



### 5.3.5 总结

![image-20210226175142066](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/053_app_to_i2c_driver.png)
...
![image-20210227143624667](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/054_i2c_driver_layers.png)
...
![image-20210227151413993](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/055_i2c_bus_dev_drv.png)
...
![image-20210227151413993](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/055_i2c_bus_dev_drv-16299605261355.png)
...
![image-20210301095132959](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/056_i2c_driver_at24.png)
...
### 8.1. i2c_adapter
  ...
  ![image-20210223103217183](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/012_i2c_adapter-16299607923736.png)

### 8.2. i2c_algorithm

![image-20210303121043020](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/058_i2c_algorithm.png)
...
>
> ![image-20210826145626299](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/image-20210826145626299.png)
...
![image-20210315101935654](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/069_i2c_block_general.png)
...
![](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/i2c-read.png)
...
![](https://raw.githubusercontent.com/zhoujinjiankim/PicGo/master/kernel.i2c/i2c-write.png)
